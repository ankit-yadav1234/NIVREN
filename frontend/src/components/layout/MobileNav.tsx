...
export function MobileNav({
  ...
  return (
    <div className="lg:hidden">
      ...
      {/* Portaled to <body>: the header this button lives in gets a
          backdrop-blur on every non-home page, which (per the CSS spec)
          makes it a containing block for `position: fixed` descendants —
          without the portal, this drawer would be clipped to the header's
          own height instead of spanning the viewport. */}
      {mounted &&
        createPortal(
          <>
            {open && (
